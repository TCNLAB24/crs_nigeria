...
# local data 
ng1_mcv1_data_path <- file.path(DATA_FOLDER, "ng1_mcv1_data.xlsx")
general_sia_scenario1_path <- file.path(DATA_FOLDER, "summarised_general_sia_scenario1.xlsx")
general_sia_scenario2_path <- file.path(DATA_FOLDER, "summarised_general_sia_scenario2.xlsx")
```
...
for (this_state in states) {
  ...
  beta_matrices_list[[this_state]] <- readRDS(file=file.path(PARAMETERS_FOLDER, this_state, "beta_matrices.rds"))[1:100]
  omegas_list[[this_state]] <- readRDS(file=file.path(PARAMETERS_FOLDER, this_state, "omegas.rds"))[1:100]
}
